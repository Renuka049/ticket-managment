...
$(document).ready(function() {
    ...
    // Sidebar toggle for small screens: toggle the sidebar collapse 'show'
    ...
    // Also toggle sidebar when app header hamburger is clicked
    ...
    // Extract and Login buttons (top-right)
    $('#extractBtn').on('click', function() {
        showAlert('info', 'Extract action triggered');
    });

    $('#loginBtn').on('click', function() {
        showAlert('success', 'Logged in (simulated)');
    });
});
